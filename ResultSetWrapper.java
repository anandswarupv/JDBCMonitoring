...
public class ResultSetWrapper implements ResultSet {
    ...
    protected StatementWrapper _statementWrapper;
    protected String _lastSql;

    public ResultSetWrapper(ResultSet resultSet, StatementWrapper statement, String lastSql) {
        _resultSet = resultSet;
        _statementWrapper = statement;
        _lastSql = lastSql;
    }
